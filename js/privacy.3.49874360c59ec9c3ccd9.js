...
function getCountryList() {
  var list = country_codes_list__WEBPACK_IMPORTED_MODULE_0___default.a.customArray({
    code: '{countryCode}',
    label: '{countryNameEn}'
  });
  list.forEach(function (country) {
    return country.label = t('privacy', country.label);
  });
  list.map(function (country) {
    country.label = t('privacy', country.label);
    return country;
  });
...
//# sourceMappingURL=privacy.3.49874360c59ec9c3ccd9.js.map