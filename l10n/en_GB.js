OC.L10N.register(
    ...
    "Error loading additional administrator." : "Error loading additional administrator.",
    "Error adding new administrator." : "Error adding new administrator.",
    "Error deleting new administrator." : "Error deleting new administrator.",
    ...
    "Error saving new state of full-disk-encryption" : "Error saving new state of full-disk-encryption",
    "Encryption" : "Encryption",
    "Edit encryption" : "Edit encryption",
    "Edit" : "Edit",
    ...
    "Error loading information about shares." : "Error loading information about shares.",
    "People you've shared with" : "People you've shared with",
    "Loading people you've shared with …" : "Loading people you've shared with …",
    "You do not have any shares with individual users." : "You do not have any shares with individual users.",
    "Your {serverName} account" : "Your {serverName} account",
    ...
    "Error saving new location of the server" : "Error saving new location of the server",
    "Where is your data?" : "Where is your data?",
    "Your data is located in:" : "Your data is located in:",
    "An admin has not selected the location of the server yet." : "An admin has not selected the location of the server yet.",
    "Change data location" : "Change data location",
    "Region" : "Region",
    "Please select a region" : "Please select a region",
    "{bold}Control{/bold} over user data access" : "{bold}Control{/bold} over user data access",
    "{bold}Knowledge{/bold} of how the data is stored" : "{bold}Knowledge{/bold} of how the data is stored",
    "{bold}Freedom{/bold} to choose a platform" : "{bold}Freedom{/bold} to choose a platform",
