OC.L10N.register(
    ...
    "Adapt encryption" : "Oiriúnú criptithe",
    "The admin has not selected the location of the server yet." : "Níl suíomh an fhreastalaí roghnaithe ag an riarthóir fós.",
    "You don't have any shares with individual users." : "Níl aon scaireanna agat le húsáideoirí aonair.",
    "Your %s account" : "Do chuntas %s",
    "Defining basic rights for people to control their own data in the internet age" : "Bunchearta a shainiú do dhaoine chun a gcuid sonraí féin a rialú san aois idirlín",
    "People you shared with" : "Daoine a roinn tú leo",
    "Read the privacy policy." : "Léigh an polasaí príobháideachta.",
