OC.L10N.register(
    ...
    "Error loading additional administrator." : "Pogreška pri učitavanju dodatnog administratora.",
    "Error adding new administrator." : "Pogreška pri dodavanju novog administratora.",
    "Error deleting new administrator." : "Pogreška pri brisanju novog administratora.",
    "Administrators" : "Administratori",
    "The following accounts are designated administrators and may potentially have access to your data through system storage or backups. However, they do not have easy access to your data via the web interface or client applications." : "Sljedeći računi označeni su kao administratori i potencijalno mogu imati pristup vašim podacima putem sustavnog pohranjivanja ili sigurnosnih kopija. Međutim, nemaju jednostavan pristup vašim podacima putem web sučelja ili klijentskih aplikacija.",
    "Loading administrators …" : "Učitavanje administratora …",
    "Remove external {propertyName} admin" : "Ukloni vanjskog administratora {propertyName}",
    "Add external admin" : "Dodaj vanjskog administratora",
    "Cancel" : "Odustani",
    "Add" : "Dodaj",
    "Name of external admin" : "Ime vanjskog administratora",
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with a master key. It means that administrators can access your files, but not read their content." : "Vaša osobna pohrana šifrirana je pomoću {linkopen}šifriranja na strani poslužitelja ↗{linkclose} s glavnim ključem. To znači da administratori mogu pristupiti vašim datotekama, ali ne mogu čitati njihov sadržaj.",
    ...
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with an individual user key. It means that administrators can access your files, but not read their content." : "Vaša osobna pohrana šifrirana je pomoću {linkopen}šifriranja na strani poslužitelja ↗{linkclose} s pojedinačnim korisničkim ključem. To znači da administratori mogu pristupiti vašim datotekama, ali ne mogu čitati njihov sadržaj.",
    ...
    "Error saving new state of full-disk-encryption" : "Pogreška pri spremanju novog stanja šifriranja cijelog diska",
    "Encryption" : "Šifriranje",
    "Edit encryption" : "Uredi šifriranje",
    "Edit" : "Uredi",
    ...
    "Read the privacy policy ↗" : "Pročitajte politiku privatnosti ↗",
    "Error loading information about shares." : "Pogreška pri učitavanju informacija o dijeljenjima.",
    "People you've shared with" : "Osobe s kojima ste podijelili",
    "Loading people you've shared with …" : "Učitavanje osoba s kojima ste podijelili …",
    "You do not have any shares with individual users." : "Nemate nijedno dijeljenje s pojedinačnim korisnicima.",
    "Your {serverName} account" : "Vaš {serverName} račun",
    ...
    "Error saving new location of the server" : "Pogreška pri spremanju nove lokacije poslužitelja",
    "Where is your data?" : "Gdje su vaši podaci?",
    "Your data is located in:" : "Vaši se podaci nalaze u:",
    "An admin has not selected the location of the server yet." : "Administrator još nije odabrao lokaciju poslužitelja.",
    "Change data location" : "Promijeni lokaciju podataka",
    "Region" : "Regija",
    "Please select a region" : "Odaberite regiju",
    "{bold}Control{/bold} over user data access" : "{bold}Kontrola{/bold} nad pristupom korisničkim podacima",
    "{bold}Knowledge{/bold} of how the data is stored" : "{bold}Uvid{/bold} u način pohrane podataka",
    "{bold}Freedom{/bold} to choose a platform" : "{bold}Sloboda{/bold} izbora platforme",
    "User Data Manifesto 2.0" : "Manifest o podacima korisnika 2.0",
    "Defining basic rights for people to control their own data in the internet age." : "Definiranje osnovnih prava ljudi za kontrolu vlastitih podataka u digitalnom dobu.",
