OC.L10N.register(
    ...
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with a master key. It means that administrators can access your files, but not read their content." : "Ihr Heimspeicher wird mit {linkopen}serverseitiger Verschlüsselung ↗{linkclose} mit einem Hauptschlüssel verschlüsselt. Dies bedeutet, dass Administratoren auf Ihre Dateien zugreifen, aber nicht deren Inhalt lesen können.",
    ...
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with an individual user key. It means that administrators can access your files, but not read their content." : "Ihr Heimspeicher wird mit {linkopen}serverseitiger Verschlüsselung ↗{linkclose} mit einem individuellen Benutzerschlüssel verschlüsselt. Dies bedeutet, dass Administratoren auf Ihre Dateien zugreifen, aber nicht deren Inhalt lesen können.",
