OC.L10N.register(
    ...
    "The following accounts are designated administrators and may potentially have access to your data through system storage or backups. However, they do not have easy access to your data via the web interface or client applications." : "Die folgenden Konten sind als Administratoren ausgewiesen und haben möglicherweise Zugriff auf Ihre Daten über Systemspeicher oder Backups. Über die Weboberfläche oder Clientanwendungen haben sie jedoch keinen einfachen Zugriff auf Ihre Daten.",
    "Loading administrators …" : "Administration wird geladen …",
    "Remove external {propertyName} admin" : "Externe {propertyName}-Administration entfernen",
    "Add external admin" : "Einen externen Administrator hinzufügen",
    "Cancel" : "Abbrechen",
    "Add" : "Hinzufügen",
    "Name of external admin" : "Name des externen Administrators",
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with a master key. It means that administrators can access your files, but not read their content." : "Ihr Heimspeicher ist mit {linkopen}serverseitiger Verschlüsselung ↗{linkclose} mit einem Hauptschlüssel verschlüsselt. Dies bedeutet, dass die Administration auf Ihre Dateien zugreifen, aber nicht deren Inhalt lesen kann.",
    "Your files on external storages may be encrypted using {linkopen}server-side-encryption ↗{linkclose} with a master key based on their configuration." : "Ihre Dateien auf externen Speichern können mittels der {linkopen}serverseitigen Verschlüsselung ↗{linkclose}  und einem Hauptschlüssel verschlüsselt werden.",
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with an individual user key. It means that administrators can access your files, but not read their content." : "Ihr Heimspeicher ist mit {linkopen}serverseitiger Verschlüsselung ↗{linkclose} mit einem individuellen Benutzerschlüssel verschlüsselt. Dies bedeutet, dass die Administration auf Ihre Dateien zugreifen, aber nicht deren Inhalt lesen kann.",
    "Your files on external storages may be encrypted using {linkopen}server-side-encryption ↗{linkclose} with an individual key based on their configuration." : "Ihre Dateien auf externen Speichern können mittels der {linkopen}serverseitigen Verschlüsselung ↗{linkclose}  und einem individuellen Benutzerschlüssel verschlüsselt werden.",
    ...
    "Error saving new state of full-disk-encryption" : "Fehler beim Speichern des neuen Status der Festplattenverschlüsselung",
    "Encryption" : "Verschlüsselung",
    "Edit encryption" : "Verschlüsselung bearbeiten",
    "Edit" : "Bearbeiten",
    ...
    "People you've shared with" : "Personen, mit denen Sie geteilt haben",
    "Loading people you've shared with …" : "Lade Personen, mit denen Sie etwas geteilt haben …",
    "You do not have any shares with individual users." : "Sie haben keine Dateien mit einzelnen Benutzern geteilt.",
    "Your {serverName} account" : "Ihr {serverName}-Konto",
    ...
    "Error saving new location of the server" : "Fehler beim Speichern des neuen Ortes des Servers",
    "Where is your data?" : "Wo sind Ihre Daten?",
    "Your data is located in:" : "Ihre Daten befinden sich in: ",
    "An admin has not selected the location of the server yet." : "Die Administration hat bislang den Ort des Servers noch nicht angegeben.",
    "Change data location" : "Datenspeicherort ändern",
    "Region" : "Region",
    "Please select a region" : "Bitte eine Region auswählen",
    "{bold}Control{/bold} over user data access" : "{bold}Kontrolle{/bold} über den Zugriff auf Benutzerdaten",
    "{bold}Knowledge{/bold} of how the data is stored" : "{bold}Wissen{/bold} darüber, wie die Daten gespeichert werden",
    "{bold}Freedom{/bold} to choose a platform" : "Die {bold}Freiheit{/bold}, eine Plattform zu wählen",
    "User Data Manifesto 2.0" : "Benutzer-Daten-Manifest 2.0",
    "Defining basic rights for people to control their own data in the internet age." : "Wir definieren grundlegende Rechte, damit Menschen ihre eigenen Daten im Internetzeitalter kontrollieren können.",
    ...
    "Zambia" : "Sambia",
    "Zimbabwe" : "Simbabwe",
    "Loading administrators …" : "Administratoren werden geladen …",
    "Loading people you've shared with …" : "Lade Personen, mit denen Sie geteilt haben …",
    "Control" : "Kontrolle",
    "over user data access" : "über den Zugriff auf Benutzerdaten",
    "Knowledge" : "Wissenswertes",
    "of how the data is stored" : "über die Art der Datenspeicherung",
    "Freedom" : "Freiheit",
    "to choose a platform" : "bei der Wahl der Plattform"
},
