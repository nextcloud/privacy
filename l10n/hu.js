OC.L10N.register(
    ...
    "{bold}Control{/bold} over user data access" : "{bold}Irányítás{/bold} a felhasználók adatai felett",
    "{bold}Knowledge{/bold} of how the data is stored" : "{bold}Tudás{/bold} az adattárolás módjáról",
    "{bold}Freedom{/bold} to choose a platform" : "{bold}Szabadság{/bold} a platformválasztásban",
