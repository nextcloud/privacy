OC.L10N.register(
    ...
    "Error loading additional administrator." : "Грешка приликом учитавања додатног администратора.",
    "Error adding new administrator." : "Грешка приликом додавања додатног администратора.",
    "Error deleting new administrator." : "Грешка приликом брисања додатног администратора.",
    "Encryption" : "Шифровање",
    "Edit encryption" : "Уреди шифрирање",
    "Edit" : "Измени",
    "This server is using full-disk-encryption." : "Овај сервер користи шифровање целог диска.",
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with a master key. It means that administrators can access your files, but not read their content." : "Ваше лично складиште је шифрирано {linkopen}енкрипцијом на страни сервера ↗{linkclose} уз употребу главног кључа. То значи да администратори могу да приступе вашим фајловима, али не могу да прочитају њихов садржај.",
    "Your files on external storages may be encrypted using {linkopen}server-side-encryption ↗{linkclose} with a master key based on their configuration." : "Ваши фајлови на спољним складиштима могу бити шифрирани {linkopen}енкрипцијом на страни сервера ↗{linkclose} уз употребу главног кључа у зависности од тога како су конфигурисана.",
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with an individual user key. It means that administrators can access your files, but not read their content." : "Ваше лично складиште се шифрира {linkopen}екрипцијом на страни сервера ↗{linkclose} уз употребу индивидуалног корисничког кључа. То значи да администратори могу да приступе вашим фајловима, али не могу да прочитају њихов садржај.",
    "Your files on external storages may be encrypted using {linkopen}server-side-encryption ↗{linkclose} with an individual key based on their configuration." : "Ваши фајлови на спољним складиштима могу бити шифрирани {linkopen}енкрипцијом на страни севера ↗{linkclose} уз употребу индивидуалног кључа, у зависности од тога како су конфигурисана.",
    "Additionally, this server is protected with full-disk-encryption." : "Уз то, овај сервер је заштићен шифрирањем комплетних дискова.",
    ...
    "Error saving new state of full-disk-encryption" : "Грешка приликом чувања новог стања шифрирања комплетног диска",
    "Privacy policy" : "Политика приватност",
    "Read the privacy policy ↗" : "Прочитајте политику приватности ↗",
    "People you've shared with" : "Људи са којима делите",
    "Loading people you've shared with …" : "Учитавају се људи са којима делите…",
    "You do not have any shares with individual users." : "Немате ниједно дељење са појединачним корисницима.",
    "Error loading information about shares." : "Грешка приликом учитавања информација у вези са дељењима.",
    ...
    "An admin has not selected the location of the server yet." : "Админ још увек није поставио локацију сервера.",
    "Change data location" : "Промени локацију података",
    "Region" : "Регија",
    "Please select a region" : "Молимо одаберите регију",
    "Error saving new location of the server" : "Грешка приликом чувања нове локације сервера",
    "User Data Manifesto 2.0" : "Манифест корисничких података 2.0",
    "Defining basic rights for people to control their own data in the internet age." : "Дефинисање основних права људи за контролу сопствених података у добу интернета.",
    "Control" : "Контрола",
    ...
    "Your {serverName} account" : "Ваш {serverName} налог",
