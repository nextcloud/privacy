OC.L10N.register(
    ...
    "Error loading additional administrator." : "Errore nel caricamento dell'amministratore aggiuntivo.",
    "Error adding new administrator." : "Errore nell'aggiunta del nuovo amministratore.",
    "Error deleting new administrator." : "Errore nell'eliminazione del nuovo amministratore.",
    ...
    "Loading administrators …" : "Caricamento amministratori …",
    ...
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with a master key. It means that administrators can access your files, but not read their content." : "La tua archiviazione home è cifrata usando la {linkopen}cifratura lato-server ↗{linkclose} con una chiave master. Significa che gli amministratori possono accedere ai file, ma non leggerne il contenuto.",
    ...
    "Error saving new state of full-disk-encryption" : "Errore nel salvataggio del nuovo stato di full-disk-encryption",
    "Encryption" : "Cifratura",
    "Edit encryption" : "Modifica crittografia",
    "Edit" : "Modifica",
    ...
    "Read the privacy policy ↗" : "Leggi l'informativa sulla privacy ↗",
    "Error loading information about shares." : "Errore nel caricamento delle informazioni sulle condivisioni.",
    "People you've shared with" : "Persone con cui hai condiviso",
    "Loading people you've shared with …" : "Caricamento delle persone con cui hai condiviso …",
    "You do not have any shares with individual users." : "Non hai alcuna condivisione con utenti singoli.",
    "Your {serverName} account" : "Il tuo account su {serverName}",
    ...
    "Error saving new location of the server" : "Errore nel salvataggio della nuova posizione del server",
    "Where is your data?" : "Dove sono i tuoi dati?",
    "Your data is located in:" : "I tuoi dati si trovano in:",
    "An admin has not selected the location of the server yet." : "Un amministratore non ha ancora selezionato la posizione del server.",
    "Change data location" : "Cambia posizione dei dati",
    "Region" : "Regione",
    "Please select a region" : "Seleziona una regione",
    "{bold}Control{/bold} over user data access" : "{bold}Controllo{/bold}sull'accesso ai dati utente",
    "{bold}Knowledge{/bold} of how the data is stored" : "{bold}Conoscenza{/bold} di come vengono memorizzati i dati",
    "{bold}Freedom{/bold} to choose a platform" : "{bold}Libertà{/bold} di scegliere una piattaforma",
    "User Data Manifesto 2.0" : "Manifesto dei dati utente 2.0",
    "Defining basic rights for people to control their own data in the internet age." : "Definizione dei diritti fondamentali delle persone per controllare i propri dati nell'era di Internet.",
    ...
    "Loading people you've shared with …" : "Caricamento persone con cui hai condiviso …",
    "Control" : "Controllo",
