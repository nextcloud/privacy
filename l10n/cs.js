OC.L10N.register(
    ...
    "Error loading additional administrator." : "Chyba při načítání dalšího správce.",
    "Error adding new administrator." : "Chyba při přidávání nového správce.",
    "Error deleting new administrator." : "Chyba při mazání nového správce.",
    "Encryption" : "Šifrování",
    "Edit encryption" : "Upravit šifrování",
    "Edit" : "Upravit",
    ...
    "Error saving new state of full-disk-encryption" : "Chyba při ukládání nového stavu celodiskového šifrování",
    ...
    "An admin has not selected the location of the server yet." : "Správce doposud nezadal umístění serveru.",
    ...
    "Your {serverName} account" : "Váš účet na {serverName}",
