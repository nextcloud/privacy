OC.L10N.register(
    ...
    "Error loading additional administrator." : "加载额外管理员时发生错误。",
    "Error adding new administrator." : "新增管理员时发生错误。",
    "Error deleting new administrator." : "删除管理员时发生错误",
    "Encryption" : "加密",
    "Edit encryption" : "编辑加密",
    "Edit" : "编辑",
    ...
    "Error saving new state of full-disk-encryption" : "存储全磁盘加密状态时发生错误",
    "Privacy policy" : "隐私政策",
    "Read the privacy policy ↗" : "阅读隐私政策 ↗",
    "People you've shared with" : "与你分享的人",
    "Loading people you've shared with …" : "正在加载与你分享的人 ...",
    ...
    "An admin has not selected the location of the server yet." : "管理员暂未选择服务器所在位置。",
    "Change data location" : "修改数据位置",
    "Region" : "区域",
    "Please select a region" : "请选择一个区域",
    "Error saving new location of the server" : "保存服务器地址时发生错误",
