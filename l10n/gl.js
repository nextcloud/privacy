OC.L10N.register(
    ...
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with a master key. It means that administrators can access your files, but not read their content." : "O teu almacenamento doméstico está cifrado mediante {linkopen}cifrado do lado do servidor ↗{linkclose} cunha chave mestra. Significa que os administradores poden acceder aos teus ficheiros, pero non ler o seu contido.",
    "Your files on external storages may be encrypted using {linkopen}server-side-encryption ↗{linkclose} with a master key based on their configuration." : "Os teus ficheiros en almacenamentos externos pódense cifrar mediante {linkopen}cifrado do lado do servidor ↗{linkclose} cunha chave mestra en función da súa configuración.",
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with an individual user key. It means that administrators can access your files, but not read their content." : "O almacenamento do teu fogar está cifrado mediante {linkopen}cifrado do lado do servidor ↗{linkclose} cunha clave de usuario individual. Significa que os administradores poden acceder aos teus ficheiros, pero non ler o seu contido.",
    "Your files on external storages may be encrypted using {linkopen}server-side-encryption ↗{linkclose} with an individual key based on their configuration." : "Os teus ficheiros en almacenamentos externos pódense cifrar mediante {linkopen}cifrado do lado do servidor ↗{linkclose} cunha clave individual en función da súa configuración.",
    ...
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with a master key." : "O teu almacenamento doméstico está cifrado mediante {linkopen}cifrado do lado do servidor ↗{linkclose} cunha chave mestra.",
    "Your home storage is encrypted using {linkopen}server-side-encryption ↗{linkclose} with an individual user key." : "O almacenamento do teu fogar está cifrado mediante {linkopen}cifrado do lado do servidor ↗{linkclose} cunha clave de usuario individual."
},
